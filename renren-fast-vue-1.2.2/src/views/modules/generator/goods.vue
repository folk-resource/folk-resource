...
<<<<<<< HEAD
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.goodsId)">查看</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.goodsId)">下载</el-button>
=======
